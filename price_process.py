import numpy as np
from agent import Agent, sample_agent
from beartype import beartype as typed
from numpy.random import default_rng
from order_book import Candle, OrderBook, Trade
from visualization import Candle
            ...
            if orders is not None:
                ...
                for order in [buy_order, sell_order]:
                    ...
                    if new_trades:
                        ...
                        period_trades.extend(new_trades)
                        current_price = new_trades[-1].price
